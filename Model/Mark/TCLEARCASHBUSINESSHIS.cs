...
namespace Model.Mark {
	...
	/// 现金流类业务历史表
	/// </summary>
	[JsonObject(MemberSerialization.OptIn), Table(Name = "T_CLEAR_CASHBUSINESS_HIS", DisableSyncStructure = true)]
	public partial class TCLEARCASHBUSINESSHIS {
		...
		/// 业务日期
		/// </summary>
		[JsonProperty, Column(Name = "L_DATE", DbType = "NUMBER(8)", IsPrimary = true)]
